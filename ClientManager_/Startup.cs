...
namespace ClientManager_
{
    public class Startup
    {
        ...
        {
            services.Configure<ClientManagerDataBaseSettings>(Configuration.GetSection(nameof(ClientManagerDataBaseSettings)));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "ClientManager_ v1"));
            }
